export default {
    ...
    beforeMount() {
        this.oncheck = new Image();
        this.oncheck.src = require(`${this.publicPath}/oncheck.png`);
        this.offcheck = new Image();
        this.offcheck.src = require(`${this.publicPath}/offcheck.png`);
        this.more = new Image();
        this.more.src = require(`${this.publicPath}/more.png`);
    },
    methods: {
        initCanvas() {
        ...
        paintCheckbox(ctx, displayRows) {
            ...
            for (const item of displayRows) {
                ...
                if (15 + item.y > -item.height) {
                    ...
                    // 修改选中状态的图表icon
                    let selectValue = item?.id ?? item?.rowIndex;
        ...
        paintNo(ctx) {
            ...
            ctx.fillText(this.headerText, serialWidth / 2, 15);
            ctx.lineWidth = 1;
